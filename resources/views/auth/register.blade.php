    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card card-box-shadow">
                ...
                <div class="card-body">
                    <h4 class="text-center text-danger">If you face any problem in registration, please send me a message in facebook <a target="_blank" href="https://www.facebook.com/messages/t/miufaysal">fb.com/miufaysal</a></h4>
                    <br/>
